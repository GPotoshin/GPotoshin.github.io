...
\subsection{Conventions, acknowledged results and definition from analysis and measure theory}
...
Now, we need to compare two measures. To do this, we can compare the values of
integrals of functions with respect to these measures; in other words, we will
...
\vspace{2ex}
\textbf{Definition:} \text{A cover of $A$ by a family $B$ is called \textbf{fine}
